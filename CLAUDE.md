...
- **Backend:** `apps-script/` (`Code.gs` doGet/doPost router + `appsscript.json`, binds **GXCore v174** —
...
App-specific facts for the sync check: app key **`crew`** in GX Core; binds `GXCore` library **v174**;
