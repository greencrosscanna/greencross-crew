...
- **Backend:** `apps-script/` (`Code.gs` doGet/doPost router + `appsscript.json`, binds **GXCore v168** —
...
App-specific facts for the sync check: app key **`crew`** in GX Core; binds `GXCore` library **v168**;
